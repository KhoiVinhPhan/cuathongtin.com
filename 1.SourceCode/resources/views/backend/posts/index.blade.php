...
<div class="panel panel-primary form">
  	<div class="panel-heading">Danh sách bài viết của bạn</div>
			...
			<table class="table table-bordered" id="table">
			    ...
			    <tbody>
			    	...
			    	@foreach($data as $item)
			    		@php($i++)
		    			<tr>
		    				<td align="center"><input class="checkbox" type="checkbox" value="" name="checkbox[]"></td>
				        	...
				        	<td>
				        		<a href="{{ route('editPost', ['post_id' => $item->post_id]) }}" title=""><button type="button" class="btn btn-info btn-xs btn-block"><span class="icon-edit"></span> Chỉnh</button></a>
